...
const Users = [
  { id: "1", uri: require("../assets/tind1.jpg") },
  { id: "2", uri: require("../assets/tind2.jpg") },
  { id: "3", uri: require("../assets/tind3.jpg") },
  { id: "4", uri: require("../assets/tind4.jpg") },
  { id: "5", uri: require("../assets/tind5.jpg") }
];
        ...
        return (
          <Animated.View
            ...
            style={[{
                ...
                height: HEIGHT - 120, width: WIDTH, padding: 10 }]}
          >
            <Image
              style={{
                flex: 1,
